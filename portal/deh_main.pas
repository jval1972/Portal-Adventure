...
begin
  ...
  mobj_tokens.Add('ACTIVE SOUND');       // .activesound              // 42 - Alias for 20
  mobj_tokens.Add('RADIUS');             // .radius                   // 43 - Alias for 16
  ...
  mobj_flags2_ex.Add('MF2_EX_DOCOMICBUBBLES');
  mobj_flags2_ex.Add('MF2_EX_RENDERROTATE');
  ...
  for i := 0 to DEHNUMACTIONS - 1 do
  begin
    deh_actions[i].action.acp1 := nil;
    deh_actions[i].name := 'NULL';
  end;
  ...
  deh_actions[156].action.acp1 := @A_DesidePlayerWalkFrame;
  deh_actions[156].name := strupper('DesidePlayerWalkFrame');
  deh_actions[157].action.acp1 := @A_PlaysoundEx;
  deh_actions[157].name := strupper('PlaysoundEx');
  deh_actions[158].action.acp1 := @A_Speak;
  deh_actions[158].name := strupper('Speak');
  deh_actions[159].action.acp1 := @A_ComicBubble;
  deh_actions[159].name := strupper('ComicBubble');
  deh_actions[160].action.acp1 := @P_RemoveMobj;
  deh_actions[160].name := strupper('RemoveSelf');
  deh_actions[161].action.acp1 := @A_SetInteractive;
  deh_actions[161].name := strupper('SetInteractive');
  deh_actions[162].action.acp1 := @A_UnSetInteractive;
  deh_actions[162].name := strupper('UnSetInteractive');
  deh_actions[163].action.acp1 := @A_DoComicBubbles;
  deh_actions[163].name := strupper('DoComicBubbles');
  deh_actions[164].action.acp1 := @A_NoComicBubbles;
  deh_actions[164].name := strupper('NoComicBubbles');
  deh_actions[165].action.acp1 := @A_SetMonsterInfight;
  deh_actions[165].name := strupper('SetMonsterInfight');
  deh_actions[166].action.acp1 := @A_UnSetMonsterInfight;
  deh_actions[166].name := strupper('UnSetMonsterInfight');
  deh_actions[167].action.acp1 := @A_NoiseAlert;
  deh_actions[167].name := strupper('NoiseAlert');
  deh_actions[168].action.acp1 := @A_TargetComicBubble;
  deh_actions[168].name := strupper('TargetComicBubble');
  deh_actions[169].action.acp1 := @A_ConsoleCommand;
  deh_actions[169].name := strupper('ConsoleCommand');
  deh_actions[170].action.acp1 := @A_E1M8;
  deh_actions[170].name := strupper('E1M8');
  deh_actions[171].action.acp1 := @A_Mission1;
  deh_actions[171].name := strupper('Mission1');
  deh_actions[172].action.acp1 := @A_Mission1Property;
  deh_actions[172].name := strupper('Mission1Property');
  deh_actions[173].action.acp1 := @A_AutoHeal;
  deh_actions[173].name := strupper('AutoHeal');
  deh_actions[174].action.acp1 := @A_ComicBubbleOnce;
  deh_actions[174].name := strupper('ComicBubbleOnce');
  deh_actions[175].action.acp1 := @A_SetCustomParam;
  deh_actions[175].name := strupper('SetCustomParam');
  deh_actions[176].action.acp1 := @A_AddCustomParam;
  deh_actions[176].name := strupper('AddCustomParam');
  deh_actions[177].action.acp1 := @A_RemoveCustomParam;
  deh_actions[177].name := strupper('RemoveCustomParam');
  deh_actions[178].action.acp1 := @A_SetTargetCustomParam;
  deh_actions[178].name := strupper('SetTargetCustomParam');
  deh_actions[179].action.acp1 := @A_AddTargetCustomParam;
  deh_actions[179].name := strupper('AddTargetCustomParam');
  deh_actions[180].action.acp1 := @A_RemoveTargetCustomParam;
  deh_actions[180].name := strupper('RemoveTargetCustomParam');
  deh_actions[181].action.acp1 := @A_MoneyThink;
  deh_actions[181].name := strupper('MoneyThink');
  deh_actions[182].action.acp1 := @A_JoeAttack;
  deh_actions[182].name := strupper('JoeAttack');
  deh_actions[182].action.acp1 := @A_JoeAttack;
  deh_actions[182].name := strupper('JoeAttack');
  deh_actions[183].action.acp1 := @A_DrFreakTeleport;
  deh_actions[183].name := strupper('DrFreakTeleport');
  deh_actions[184].action.acp1 := @A_DrFreakAttack;
  deh_actions[184].name := strupper('DrFreakAttack');
  deh_actions[185].action.acp1 := @A_DrFreakBubble;
  deh_actions[185].name := strupper('DrFreakBubble');
  deh_actions[186].action.acp1 := @A_DrFreakDesideTeleport;
  deh_actions[186].name := strupper('DrFreakDesideTeleport');
  deh_actions[187].action.acp1 := @A_BeggarSee;
  deh_actions[187].name := strupper('BeggarSee');
  deh_actions[188].action.acp1 := @A_BeggarInteract;
  deh_actions[188].name := strupper('BeggarInteract');
  deh_actions[189].action.acp1 := @A_PlayerFaceMe;
  deh_actions[189].name := strupper('PlayerFaceMe');
  deh_actions[190].action.acp1 := @A_BeggarDeside;
  deh_actions[190].name := strupper('BeggarDeside');
  deh_actions[191].action.acp1 := @A_BeggarLook;
  deh_actions[191].name := strupper('BeggarLook');
  deh_actions[192].action.acp1 := @A_FreakLook;
  deh_actions[192].name := strupper('FreakLook');
  deh_actions[193].action.acp1 := @A_PlayerAngle;
  deh_actions[193].name := strupper('PlayerAngle');
  deh_actions[194].action.acp1 := @A_E1M1;
  deh_actions[194].name := strupper('E1M1');
  deh_actions[195].action.acp1 := @A_E1M2;
  deh_actions[195].name := strupper('E1M2');
  deh_actions[196].action.acp1 := @A_E1M2_PORTAL;
  deh_actions[196].name := strupper('E1M2_PORTAL');
  deh_actions[197].action.acp1 := @A_E1M3_PORTAL;
  deh_actions[197].name := strupper('E1M3_PORTAL');
  deh_actions[198].action.acp1 := @A_E1M4_PORTAL;
  deh_actions[198].name := strupper('E1M4_PORTAL');
  deh_actions[199].action.acp1 := @A_E1M5_PORTAL;
  deh_actions[199].name := strupper('E1M5_PORTAL');
  deh_actions[200].action.acp1 := @A_E1M6_PORTAL;
  deh_actions[200].name := strupper('E1M6_PORTAL');
  deh_actions[201].action.acp1 := @A_E1M7_PORTAL;
  deh_actions[201].name := strupper('E1M7_PORTAL');
  deh_actions[202].action.acp1 := @A_E1M8_PORTAL;
  deh_actions[202].name := strupper('E1M8_PORTAL');
  deh_actions[203].action.acp1 := @A_E1M9_PORTAL;
  deh_actions[203].name := strupper('E1M9_PORTAL');
  deh_actions[204].action.acp1 := @A_Manager_A;
  deh_actions[204].name := strupper('Manager_A');
  deh_actions[205].action.acp1 := @A_EgyptBox;
  deh_actions[205].name := strupper('EgyptBox');
  deh_actions[206].action.acp1 := @A_E1M3;
  deh_actions[206].name := strupper('E1M3');
  deh_actions[207].action.acp1 := @A_SectorAutoAlign;
  deh_actions[207].name := strupper('SectorAutoAlign');
  deh_actions[208].action.acp1 := @A_Manager_Look;
  deh_actions[208].name := strupper('Manager_Look');
  deh_actions[209].action.acp1 := @A_E1M4;
  deh_actions[209].name := strupper('E1M4');
  deh_actions[210].action.acp1 := @A_Manager_B;
  deh_actions[210].name := strupper('Manager_B');
  deh_actions[211].action.acp1 := @A_Manager_Look_B;
  deh_actions[211].name := strupper('Manager_Look_B');
  deh_actions[212].action.acp1 := @A_RaptorChase;
  deh_actions[212].name := strupper('RaptorChase');
  deh_actions[213].action.acp1 := @A_E1M5;
  deh_actions[213].name := strupper('E1M5');
  deh_actions[214].action.acp1 := @A_Manager_C;
  deh_actions[214].name := strupper('Manager_C');
  deh_actions[215].action.acp1 := @A_FreakA_1;
  deh_actions[215].name := strupper('FreakA_1');
  deh_actions[216].action.acp1 := @A_FreakA_2;
  deh_actions[216].name := strupper('FreakA_2');
  deh_actions[217].action.acp1 := @A_FreakA_3;
  deh_actions[217].name := strupper('FreakA_3');
  deh_actions[218].action.acp1 := @A_SpawnWaterSplash;
  deh_actions[218].name := strupper('SpawnWaterSplash');
  deh_actions[219].action.acp1 := @A_E1M6;
  deh_actions[219].name := strupper('E1M6');
  deh_actions[220].action.acp1 := @A_E1M7;
  deh_actions[220].name := strupper('E1M7');
  deh_actions[221].action.acp1 := @A_Manager_D;
  deh_actions[221].name := strupper('Manager_D');
  deh_actions[222].action.acp1 := @A_Majong_A;
  deh_actions[222].name := strupper('Majong_A');
  deh_actions[223].action.acp1 := @A_Majong_B;
  deh_actions[223].name := strupper('Majong_B');
  deh_actions[224].action.acp1 := @A_Majong_C;
  deh_actions[224].name := strupper('Majong_C');
