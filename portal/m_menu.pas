...
var
  menudrawitems: TDStringList = nil;
...
begin
  ...
  begin
    ...
    begin
      savegamestrings[i] := S_EMPTY_SLOT;
      LoadMenu[i].status := 0;
      continue;
    end;
...
begin
  for i := 0 to Ord(load_end) - 1 do
  begin
    if savegamestrings[i] = S_EMPTY_SLOT then
    begin
      if itemOn = i then
        menudrawitems.Add('20b')
      else
        menudrawitems.Add('20a');
    end
    else
    begin
      if itemOn = i then
        menudrawitems.Add('2' + itoa(i + 1) + 'b')
      else
        menudrawitems.Add('2' + itoa(i + 1) + 'a')
    end;
  end;
...
begin
  if itemOn = 0 then
    menudrawitems.Add('01b')
  else
    menudrawitems.Add('01a');

  if itemOn = 1 then
    menudrawitems.Add('02b')
  else
    menudrawitems.Add('02a');

  if itemOn = 2 then
    menudrawitems.Add('03b')
  else
    menudrawitems.Add('03a');

  if itemOn = 3 then
    menudrawitems.Add('04b')
  else
    menudrawitems.Add('04a');
  ...
  begin
    if itemOn = 4 then
      menudrawitems.Add('05b')
    else
      menudrawitems.Add('05a');
  end
  else
  begin
    if itemOn = 4 then
      menudrawitems.Add('06b')
    else
      menudrawitems.Add('06a');
  end;
...
begin
  if itemOn = 0 then
    menudrawitems.Add('11b')
  else
    menudrawitems.Add('11a');

  if itemOn = 1 then
    menudrawitems.Add('12b')
  else
    menudrawitems.Add('12a');

  if itemOn = 2 then
    menudrawitems.Add('13b')
  else
    menudrawitems.Add('13a');

  if itemOn = 3 then
    menudrawitems.Add('14b')
  else
    menudrawitems.Add('14a');
...
begin
  ...
  if menuactive and (ch = KEY_F1) then
  begin
...
procedure M_Init;
begin
  menudrawitems := TDStringList.Create;
  currentMenu := @MainDef;
  menuactive := false;
  itemOn := currentMenu.lastOn;
  whichSkull := 0;
