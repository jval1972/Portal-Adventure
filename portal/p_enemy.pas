...
//
//==============================================================================
procedure A_LookForMonsters(actor: Pmobj_t);
...
//
//==============================================================================
procedure A_PlayerDie(mo: Pmobj_t);
...
begin
  ...
  if not seeyou then
  begin
    if not P_LookForMonsters(actor) then
      exit;
  end;
...
begin
  ...
  begin
    P_RadiusAttack(thingy, thingy.target, 32);  // jval: (was 128)
    P_HitFloor(thingy);
  end;
end;
...
begin
  ...
  youwon := true;
  EV_Teleport(@junk, 0, players[i].mo);
end;
