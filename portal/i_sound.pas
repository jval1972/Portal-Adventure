...
procedure I_PlayMediaSound(id: integer);
...
begin
  ...
  begin
    ...
    ZeroMemory(@soundparams[id], SizeOf(soundparam_t));
  end;
    ...
    repeat
      ...
      begin
        ...
        begin
          ...
          sparm.freq := wavformat.nSamplesPerSec;      // SOS JVAL SOS sparm.length!!!!!!
...
begin
  ...
  begin
    ...
    begin
      I_DevWarning('I_StartSound(): External sound %d (%s) caused a problem and will be discarded'#13#10, [id, S_sfx[id].name]);
...
begin
  I_CacheSFX(id);
  sndPlaySound(S_sfx[id].data, SND_ASYNC or SND_MEMORY);
end;
