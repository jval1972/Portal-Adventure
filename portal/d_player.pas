...
//
  player_t = record
    ...
    numparams: integer;
    params: array[0..128] of mobjcustomparam_t;
    do_updateparams: boolean;
    quaketics: integer;
    radiouskeep: fixed_t;
    radiousx, radiousy: integer;
    radiousticks: Integer;
    underwatertics: integer;
    lowgravtics: integer;
    minimumz: fixed_t;
    thrustmodifier: float;
  end;
  Pplayer_t = ^player_t;
