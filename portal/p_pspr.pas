...
begin
  ...
  if (player.mo.state = @states[Ord(S_PLAY_ATK1)]) or
     (player.mo.state = @states[Ord(S_PLAY_ATK2)]) or
     (player.mo.state = @states[Ord(S_PLAY_ATK3)]) or
     (player.mo.state = @states[Ord(S_PLAY_ATK4)]) or
     (player.mo.state = @states[Ord(S_PLAY_ATK5)]) or
     (player.mo.state = @states[Ord(S_PLAY_ATK6)]) or
     (player.mo.state = @states[Ord(S_PLAY_ATK7)]) or
     (player.mo.state = @states[Ord(S_PLAY_ATK8)]) then
