...
const
  ...
  // Allow Comic bubbles :)
  MF2_EX_DOCOMICBUBBLES = $400;
  // Rotate while rendering
  MF2_EX_RENDERROTATE = $800;
...
// Map Object definition.
  ...
  mobj_t = record
    ...
    anglex, angley, anglez: float; // custom rotate
    ...
    // interactdata: integer;
    fastchasetics: integer;

    key: integer;

    // Custom parameters (xmen)
